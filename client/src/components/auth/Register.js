...
class Register extends Component {
  ...
  render() {
    // curly braces allows us to pull out of errors
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8 m-auto">
              ...
              Create your DevConnector account</p>
              <form noValidate onSubmit={this.onSubmit}>         <div className="form-group">
                <input 
                type="text" 
              ...
              <div className="form-group">
                ...
                {errors.password && (
                <div
                  className="invalid-feedback">{errors.password}
                  </div>)}
              </div>
              <div className="form-group">
                <input 
